...
##Methods
#1.Instance methods-->must access with object name objects-->we can access both class variables and instance variables inside instance method
#------------------
#2.class-->@classmethod
#3.static-->@staticmethod

#class methods:but we can call class method using class name or object name
#-------------
"""class Student:
    college="ADITYA"#class variable or static variables
    def __init__(self,n,rollno,per):#constructor is a instance method
...
#we can access only class variables and class methods but not instance variables and instance methods from class methods
